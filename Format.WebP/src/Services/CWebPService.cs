...
{
    public class CWebPService : ICWebPService
    {
        public static string BinaryName { get { return "cwebp"; } }
        ...
        public CWebPService(string binaryPath)
        {
        ...
        private void ScanForBinary()
        {
            ...
            if(BinaryPath == null)
                throw new InvalidProgramException($"Could not find binary ${BinaryName} in ${pathVar}. Is cwebp installed?");
        }
