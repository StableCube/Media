...
{
    public class WebPMuxService : IWebPMuxService
    {
        public static string BinaryName { get { return "webpmux"; } }

        public static string BinaryPath { get; private set; }

        public WebPMuxService()
        {
            ScanForBinary();
        }

        public WebPMuxService(string binaryPath)
        {
